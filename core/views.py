...
def about(request):
    ...
    return render(request, 'core/front_page_about.html', {'persons': personals})
...
def pricing(request):
    ...
    return render(request, 'core/front_page_pricing.html', {'pricing': pricing})
...
def contacts(request):
    ...
    return render(request, 'core/front_page_contacts.html', {'contacts': contacts})